...
if(!empty($_POST)){
  //$_POSTにデータが入っていて$_SESSION['data']の中身も空のとき
    ...
    if(empty($error_msg)){
        $_SESSION['data'] = $_POST;
        header('Location: top_enterprise_Registration2.php');
        exit();
    }
...
<div id="contents">
    ...
    <p class="red" style = "text-align:center;">
      ...
      ?>
			...
			<form name="form" action="top_enterprise_Registration.php" method="POST" onSubmit="return check()">
				<dl class="clearfix">
          ...
          <input type="submit" value="登&emsp;録" id="submit_btn">
				</dl>
        <dl>
